...
export const loadAllOrders = async (exchange, dispatch) => {
  ...
  const cancelledStream = await exchange.getPastEvents('Cancel', {
    fromBlock: 0,
    toBlock: 'latest',
  })
  ...
  // filled orders with 'Trade' event stream
...
export const subscribeToEvents = async (exchange, dispatch) => {
  exchange.events.Cancel({}, (err, eve) => {
    dispatch(orderCancelled(eve.returnValues))
  })

  exchange.events.Trade({}, (err, eve) => {
    dispatch(orderFilled(eve.returnValues))
  })
}
